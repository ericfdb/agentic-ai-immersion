...
def get_agent() -> Agent:
    """Create and return an Agent with Bing Grounding search tool.

    This function creates an Agent configured with:
    ...
    Returns:
        Agent: A configured agent ready to handle web search queries
    """
    ...
    # Create Bing Grounding search tool using AzureAIAgentClient
    ...
    # Create Agent with the Bing search tool
    agent = Agent(
        client=chat_client,
        name="WebSearchAgent",
        instructions=(
